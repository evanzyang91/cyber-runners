...
def main():
    ...
    menuloop = pygame.mixer.Sound("menuloop.mp3")
    menuloop.set_volume(0.3)
    menuloop.play()

    play = pygame.mixer.Sound("play.mp3")
    play.set_volume(0.3)

    background = background.convert()
    background = pygame.image.load("background.jpg")
    menu_screen = pygame.image.load("CYBERSTRIKE.png")
            ...
            if event.type == pygame.QUIT:
                ...
                if button:
                    if event.key == pygame.K_1:
                        ...
                        pygame.mixer.music.load("gameloop1.mp3")
                        ...
                        level2_load.run()
                        menuloop.set_volume(0)
                        pygame.mixer.music.load("gameloop2.mp3")
                        pygame.mixer.music.set_volume(0.05)
                        pygame.mixer.music.play(-1)
                        button = False
                        ...
                        level3_load.run()
                        menuloop.set_volume(0)
                        pygame.mixer.music.load("gameloop3.mp3")
                        pygame.mixer.music.set_volume(0.05)
                        pygame.mixer.music.play(-1)
                        button = False
