level0 = {
    'icon_pos':(205, 220),
    'unlock': 1,
    'coins':'Final/leveldata/0/level0_coins.csv',
    'constraints':'Final/leveldata/0/level0_constraints.csv',
    'enemies':'Final/leveldata/0/level0_enemies.csv',
    'objects':'Final/leveldata/0/level0_objects.csv',
    'player':'Final/leveldata/0/level0_player.csv',
    'terrain':'Final/leveldata/0/level0_terrain.csv',
    'walls':'Final/leveldata/0/level0_walls.csv',
    'icon_img':'Final/visuals/level/level0_cover.png'
}
